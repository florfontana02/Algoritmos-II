...
TEST_F(LollaTest, hackear_altera_mayor_gastador) {
    FachadaLollapatuza l(personas, puestos);
    l.registrarCompra(2,5,3,2);
    l.registrarCompra(4,7,4,6);
    l.registrarCompra(8,7,2,7);

    EXPECT_EQ(l.gastoTotal(2), 7500);
    EXPECT_EQ(l.gastoTotal(4), 8000); //mayor gastador antes de hackear
    EXPECT_EQ(l.gastoTotal(8), 3600);
    EXPECT_EQ(l.gastoTotal(9), 0);
    EXPECT_EQ(l.mayorGastador(), 4);

    EXPECT_EQ(l.stockEnPuesto(6, 7), 1); //stock antes de hackear

    l.hackear(4,7);

    EXPECT_EQ(l.gastoTotal(2), 7500);//mayor gastador despues de hackear
    EXPECT_EQ(l.gastoTotal(4), 6000);
    EXPECT_EQ(l.gastoTotal(8), 3600);
    EXPECT_EQ(l.gastoTotal(9), 0);

    EXPECT_EQ(l.mayorGastador(), 2);

    EXPECT_EQ(l.stockEnPuesto(6, 7), 2);//stock despues de hackear
    ...
    EXPECT_EQ(l.gastoEnPuesto(2, 2), 7500);
    EXPECT_EQ(l.gastoEnPuesto(2, 4), 0);
    EXPECT_EQ(l.gastoEnPuesto(2, 8), 0);
    EXPECT_EQ(l.gastoEnPuesto(2, 9), 0);

    EXPECT_EQ(l.gastoEnPuesto(6, 2), 0);
    EXPECT_EQ(l.gastoEnPuesto(6, 4), 6000); // porque fue hackeada esta venta
    EXPECT_EQ(l.gastoEnPuesto(6, 8), 0);
    EXPECT_EQ(l.gastoEnPuesto(6, 9), 0);

    EXPECT_EQ(l.gastoEnPuesto(7, 2), 0);
    EXPECT_EQ(l.gastoEnPuesto(7, 4), 0);
    EXPECT_EQ(l.gastoEnPuesto(7, 8), 3600);
    EXPECT_EQ(l.gastoEnPuesto(7, 9), 0);

    EXPECT_EQ(l.idsDePuestos(), idsPuestos);
}

TEST_F(LollaTest, hackear_altera_menor_stock) {
    FachadaLollapatuza l(personas, puestos);
    l.registrarCompra(2, 5, 11, 2);

    EXPECT_EQ(l.gastoTotal(2), 27500);
    EXPECT_EQ(l.gastoTotal(4), 0);
    EXPECT_EQ(l.gastoTotal(8), 0);
    EXPECT_EQ(l.gastoTotal(9), 0);
    ...
    EXPECT_EQ(l.menorStock(3), 6);
    EXPECT_EQ(l.menorStock(4), 2);
    EXPECT_EQ(l.menorStock(5), 2); //antes de hackear
    EXPECT_EQ(l.menorStock(7), 6);

    l.hackear(2,5);
    l.hackear(2,5);

    EXPECT_EQ(l.gastoTotal(2), 22500);
    EXPECT_EQ(l.gastoTotal(4), 0);
    EXPECT_EQ(l.gastoTotal(8), 0);
    EXPECT_EQ(l.gastoTotal(9), 0);
    ...
    EXPECT_EQ(l.menorStock(3), 6);
    EXPECT_EQ(l.menorStock(4), 2);
    EXPECT_EQ(l.menorStock(5), 7); //despues de hackear
    EXPECT_EQ(l.menorStock(7), 6);
    EXPECT_EQ(l.personas(), personas);
    EXPECT_EQ(l.idsDePuestos(), idsPuestos);
}

TEST_F(LollaTest, hackear_puesto_no_hackeable) {
    FachadaLollapatuza l(personas, puestos);
    l.registrarCompra(2, 3, 1, 2);
    l.registrarCompra(2, 3, 3, 6);
    l.hackear(2,3);
    EXPECT_EQ(l.gastoEnPuesto(2, 2), 0);
    l.hackear(2,3);
    EXPECT_EQ(l.gastoEnPuesto(6, 2), 1000);
    EXPECT_EQ(l.gastoEnPuesto(2, 2), 0);
}
